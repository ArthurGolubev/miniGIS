...
export const OpenVec = ({showLayerAddControl}: {showLayerAddControl: (status: string) => void}) => {
            ...
            onCompleted: data => {
                ...
                switch (data.shpRead.features[0].geometry.type) {
                    ...
                    case 'Polygon':
                        ...
                        break;
                    default:
                        console.log('Default case (1) from OpenVec.tsx -> ', data.shpRead.features[0].geometry.type)
                        break;
                }
                let data1: Shape
                data1 = {
                    ...
                    Object.entries(attr).map((prop: [string, string]) => {
                        ...
                        switch (prop[0].split('_').slice(-1)[0]) {
                            ...
                            case "N":
                                ...
                                break;
                            default:
                                console.log('DEFAULT CASE (2) from OpenVec.tsx -> ', prop[0].split('_').slice(-1)[0])
                                break;
                        }
